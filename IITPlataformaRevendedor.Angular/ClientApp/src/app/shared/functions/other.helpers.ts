...
export const generarCodigoCaracteres = (): string => {
  ...
  codigoADevolver = `${anho}${mes}${dia}${hora}${minutos}${segundos}${milisegundosConFormato}${letraRandom(2)}`;
  return codigoADevolver;

}

export const letraRandom = (length : number): string => {
  var result = '';
